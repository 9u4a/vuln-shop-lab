...
const schemas = {
  ...
  Order: {
    ...
    properties: {
      ...
      shareToken: { type: 'string', nullable: true, description: 'base64(orderId)' },
      shipping: {
        type: 'object',
        nullable: true,
        properties: {
  ...
  Shipment: {
    ...
    properties: {
      ...
      status: { type: 'string', enum: ['preparing', 'shipped', 'delivered'] },
    },
  },
  ShipmentTrack: {
    type: 'object',
    properties: {
      ...
      shipAddressDetail: { type: 'string', nullable: true },
    },
  },
  SharedOrder: {
    type: 'object',
