...
- Documented as **VULN-003** (`docs/vulnerabilities/VULN-003-default-admin-credentials.md`) — hardcoded default credentials is explicitly in scope per `CLAUDE.md`'s OWASP category list (Security Misconfiguration). Not remediated, by design.
